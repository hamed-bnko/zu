...
import { addSpeechItem } from 'redux/actions';
...
const AddFileModal = ({ itemId, itemName, modalOpen, toggleModal }) => {
  ...
  const addfile = () => {
    ...
    if (Image === '' || Details === '' || name === '') {
      ...
      dispatch(addSpeechItem(payload));
      setDetails('');
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleModal}>
        <IntlMessages id="speech.add-new" />
      </ModalHeader>
      <ModalBody>
        <Label className="mt-4">
          <IntlMessages id="speech.image" />
        </Label>
        <Input
          type="file"
        ...
        />
        <Label className="mt-4">
          <IntlMessages id="speech.adjective" />
        </Label>
        <Input
          type="text"
        ...
        <br />
        <CardTitle>
          <IntlMessages id="speech.details" />
        </CardTitle>
        <ReactQuill
          theme="snow"
          value={Details}
